...
public class NReinas {
    ...
    //verifica que el tamaño del tablro sea mayor que 4
    ...
    //verifica las casilla horizontal, diagonal , vertical
   ...
   //busca una solucion del problema
   ...
   //calcula todas las posibles soluciones del problema
   ...
   //añade la solucion al array
   private void agregarSolucion(){
        soluciones.add(this.solucion);
    }

    //verifica que la solucion encontrada no este dentro del array
    ...
    //revisa que 2 respuestas no sean iguales
